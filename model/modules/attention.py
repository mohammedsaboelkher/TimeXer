...
class MHAttention(nn.Module):
    ...
    Args:
        ...
        attn_embed_dim (int): total embedding dim of combined heads post input projection. Each head has dim   
            attn_embed_dim // n_heads
    ...
    def forward(
        ...
        Returns:
            torch.Tensor: output of shape (N, L_q, value_embed_dim)
        """
        if self._qkv_same_embed_dim:
